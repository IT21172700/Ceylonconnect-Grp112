            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
              <Form>
                <label class="form-label" for="form3Example3">
                  Select the places that you want to visit
                </label>
                <div>
                ...
                <div>
                  <InputGroup className="mb-4">
                    ...
                    <Form.Control
                      aria-label="Text input with checkbox"
                      placeholder="Sabaragamuwa Province"
                    />
                  </InputGroup>
                </div>
                ...
                <div>
                  <InputGroup className="mb-4">
                    ...
                    <Form.Control
                      aria-label="Text input with checkbox"
                      placeholder="North Central Province"
                    />
                  </InputGroup>
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <Form.Control
                      type="number"
                      placeholder="Enter number of dates that you wish to travel"
                    />
                  </Form.Group>
